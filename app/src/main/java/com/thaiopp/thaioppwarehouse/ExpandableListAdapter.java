...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        String itemText = listItem.transId + "     " + listItem.poId;
        String itemDate = listItem.transDate;
        ...
        //TextView txtListItemStatus = (TextView) convertView.findViewById(R.id.lblListItemStatus);
