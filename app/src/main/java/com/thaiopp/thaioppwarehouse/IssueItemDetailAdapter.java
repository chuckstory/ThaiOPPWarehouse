...
public class IssueItemDetailAdapter extends BaseAdapter {
    ...
    public IssueItemDetailAdapter(IssueDetailActivity issueDetailActivity, List<ListItemDetail> lsItem) {
        // TODO Auto-generated constructor stub
        result = lsItem;
        context = issueDetailActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvDetail2.setText("ID : " + result.get(position).itemDetail);
        ...
        holder.tvItemStatus.setText(result.get(position).GetItemStatus());
