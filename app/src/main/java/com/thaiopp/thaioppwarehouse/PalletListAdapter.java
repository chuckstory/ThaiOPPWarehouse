...
public class PalletListAdapter extends BaseAdapter {
    ...
    public PalletListAdapter(PalletMainActivity palletMainActivity, List<ItemInfo> lsCheckItem) {
        // TODO Auto-generated constructor stub
        checkItem = lsCheckItem;
        context = palletMainActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.pallet_itemdetail, null);
