...
public class IssueDetailActivity extends AppCompatActivity
    ...
    private IssueItemDetailAdapter cAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.issue_detaillist_layout);
        c = getApplicationContext();
        data = new DataUtil(c);
        Intent intent = getIntent();
        stockSeq = intent.getStringExtra("stockSeq");
    ...
    private void dataGen(String v) {
        ...
        lsItemDetail = data.getIssueList(stockSeq);
        listView = (ListView) findViewById(R.id.lvItemDetail);
        listView.setAdapter(new IssueItemDetailAdapter(this, lsItemDetail));
        ...
        if (searchResult >= 0) {
            if (!(lsItemDetail.get(searchResult).itemAlert == 1)) {
                if (checkLocationRule(iInfo.itemLocation)) {
                    ...
                    itm.itemPallet = iInfo.itemPallet;
    ...
    public void updateListView() {
        cAdapter = new IssueItemDetailAdapter(this, lsItemDetail);
    ...
    private void updateData() {
        ...
        if (data.saveIssue(lsRoll, lsPallet)) {
            Toast.makeText(IssueDetailActivity.this, getString(R.string.msg_save_success), Toast.LENGTH_LONG).show();
