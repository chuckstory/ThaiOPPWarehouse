...
public class CheckListAdapter extends BaseAdapter {
    ...
    public CheckListAdapter(CheckMainActivity checkMainActivity, List<ItemStockInfo> lsCheckItem) {
        // TODO Auto-generated constructor stub
        checkItem = lsCheckItem;
        context = checkMainActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvItemStatus.setText(checkItem.get(position).itemCount + " / " + checkItem.get(position).itemQty );
